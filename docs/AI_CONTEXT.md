...
- **ПРИ ЗАВИСАНИИ CLI КОМАНД:**
    - ВСЕГДА проверять event loop конфликты
    - ВСЕГДА добавлять CLI обработку аргументов в MCP серверы
    - ВСЕГДА тестировать на простых командах перед сложными
    - НИКОГДА не предполагать что команда работает без проверки

- **ПРИ ОТСУТСТВИИ ОБРАТНОЙ СВЯЗИ:**
    - ВСЕГДА показывать реальные результаты, а не описывать действия
    - ВСЕГДА логировать все этапы выполнения
    - ВСЕГДА диагностировать проблемы, а не предполагать
    - НИКОГДА не описывать что "сделаю", а делать и показывать

- **ПРИ ВЫПОЛНЕНИИ ЗАДАЧ:**
    - ВСЕГДА выполнять команды и показывать результат
    - ВСЕГДА тестировать на реальных данных
    - ВСЕГДА давать обратную связь о прогрессе
    - НИКОГДА не останавливаться на описании планов

- **ПРИ ПОВТОРЯЮЩИХСЯ ПРОБЛЕМАХ:**
    - ВСЕГДА искать корень проблемы, а не симптомы
    - ВСЕГДА проверять зависимости и импорты
    - ВСЕГДА тестировать изоляцию компонентов
    - НИКОГДА не чинить одно и то же несколько раз 