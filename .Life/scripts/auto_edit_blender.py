#!/usr/bin/env python3
"""
Автоматическое редактирование Blender с открытием
"""
...
def create_auto_edit_script():
    """Создает скрипт для автоматического редактирования"""
    script = '''
import bpy
import bmesh
import math
...
print("🔧 Автоматическое редактирование сцены...")
...
bpy.ops.wm.save_as_mainfile(filepath="output/blender/edited_scene.blend")
print("💾 Отредактированная сцена сохранена: output/blender/edited_scene.blend")
'''
    return script

def run_auto_edit():
    """Запускаем автоматическое редактирование"""
    script_content = create_auto_edit_script()
    ...
    try:
        print("🔧 Автоматическое редактирование Blender...")
        print("🚀 Открытие Blender с автоматическим редактированием...")
        
        # Запускаем Blender с автоматическим выполнением скрипта
        subprocess.Popen([
            blender_path,
            "--python", script_path
        ])
        ...
        print("🔧 Автоматически применяются улучшения:")
        print("   - 💎 Улучшение кристаллов")
        print("   - ⚡ Улучшение сфер")
        print("   - 🔄 Улучшение колец")
        print("   - ✨ Добавление новых элементов")
        print("   - 💡 Улучшение освещения")
        print("   - 🎭 Настройка рендера")
        print("")
        print("💾 Результат сохранится как: edited_scene.blend")
...
if __name__ == "__main__":
    ...
    print("\n✨ Готово! Blender откроется с автоматическими улучшениями!") 