#!/usr/bin/env python3
"""
Глубокий поиск Arsentiy во всех записях
"""
...
def search_arsentiy_in_tasks():
    ...
    print("\n🔍 ГЛУБОКИЙ ПОИСК ARSENTIY В TASKS DATABASE")
    print("=" * 50)
...
def search_arsentiy_in_subtasks():
    ...
    print("\n🔍 ГЛУБОКИЙ ПОИСК ARSENTIY В SUBTASKS DATABASE")
    print("=" * 50)
